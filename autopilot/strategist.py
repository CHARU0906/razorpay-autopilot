...
class ActionScore:
    ...
    p_source: str = "prior-scored"  # "model-scored" | "prior-scored" — for Decision view badge
...
def _p_success(
    ...
    *,
    ...
    """Return (p_success, p_source) where p_source is 'model-scored' | 'prior-scored'."""
    if action == "stop":
        return 0.0, "prior-scored"
    ...
    if action in RETRY_DELAYS:
        ...
        p_source = "model-scored"   # fitted logistic regression on training seeds
        ...
        p_source = "prior-scored"   # lookup table from costs.yaml
        ...
        p_source = "prior-scored"   # calibrated prior from costs.yaml + class correction
        ...
        p_source = "prior-scored"   # lookup table + _class_action_fit multiplier
    ...
    return max(0.0, min(0.98, p_base * fatigue * contact_factor)), p_source
